...
In addition to the Pay-As-You-Go model for log data, Azure Mmonitor Log Analytics has Commitment Tiers, which enable you to save as much as 30% compared to the Pay-As-You-Go price. The Commitment Tiers pricing enables you to set a lower price for all your data ingestion at just 100 GB/day. Any usage above the Commitment Tier will be billed at the same low price. [Learn more](https://azure.microsoft.com/en-us/pricing/details/monitor/) about Commitment Tiers pricing.
